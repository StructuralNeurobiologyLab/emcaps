...
parser.add_argument(
    ...
    default='~/tum/trainings3_hek/__EffNetV2__21-12-23_01-36-44/model_step20000.pt',
    # default='~/tum/trainings3_hek/erasemaskbg___EffNetV2__21-12-23_03-24-25/model_step10000.pt',
)
...
# HEK only
patches_v2_root = os.path.expanduser('~/tum/patches_v2_hek')
...
valid_dataset = Patches(
    descr_sheet=(f'{patches_v2_root}/patchmeta_traintest.xlsx', 'Sheet1'),
    train=False,
...
cma.figure_.savefig(f'{patches_v2_root}/patch_confusion_matrix.pdf')
